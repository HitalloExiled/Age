...
/// </summary>
internal unsafe delegate shaderc_include_result* IncludeResolveFn(void* userData, byte* requestedSource, int type, byte* requestingSource, size_t includeDepth);

/// <summary>
/// An includer callback type for destroying an include result.
/// </summary>
internal unsafe delegate void IncludeResultReleaseFn(void* userData, shaderc_include_result* includeResult);
