...
internal record struct CameraData
{
    ...
    public Transform3D<RealT>[] ViewOffset     { get; } = new Transform3D<RealT>[RendererSceneRender.MAX_RENDER_VIEWS];
    public Projection<RealT>[]  ViewProjection { get; } = new Projection<RealT>[RendererSceneRender.MAX_RENDER_VIEWS];
...
internal class RendererSceneRender
{
    ...
    internal bool IsEnvironment(Guid environment) => throw new NotImplementedException();
    internal void SetScenePass(int renderPass) => throw new NotImplementedException();
}
