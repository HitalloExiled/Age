...
public enum VkFormat : uint
{
    ...
    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has an 8-bit G component in plane 0, an 8-bit B component in plane 1, and an 8-bit R component in plane 2. The horizontal and vertical dimensions of the R and B planes are halved relative to the image dimensions, and each R and B component is shared with the G components for which ⌊i G ×0.5⌋=i B =i R  and ⌊j G ×0.5⌋=j B =j R . The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, VK_IMAGE_ASPECT_PLANE_1_BIT for the B plane, and VK_IMAGE_ASPECT_PLANE_2_BIT for the R plane. This format only supports images with a width and height that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G8_B8_R8_3PLANE_420_UNORM = 1000156002,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has an 8-bit G component in plane 0, and a two-component, 16-bit BR plane 1 consisting of an 8-bit B component in byte 0 and an 8-bit R component in byte 1. The horizontal and vertical dimensions of the BR plane are halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R and ⌊j G ×0.5⌋=j B =j R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, and VK_IMAGE_ASPECT_PLANE_1_BIT for the BR plane. This format only supports images with a width and height that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G8_B8R8_2PLANE_420_UNORM = 1000156003,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has an 8-bit G component in plane 0, an 8-bit B component in plane 1, and an 8-bit R component in plane 2. The horizontal dimension of the R and B plane is halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, VK_IMAGE_ASPECT_PLANE_1_BIT for the B plane, and VK_IMAGE_ASPECT_PLANE_2_BIT for the R plane. This format only supports images with a width that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G8_B8_R8_3PLANE_422_UNORM = 1000156004,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has an 8-bit G component in plane 0, and a two-component, 16-bit BR plane 1 consisting of an 8-bit B component in byte 0 and an 8-bit R component in byte 1. The horizontal dimension of the BR plane is halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, and VK_IMAGE_ASPECT_PLANE_1_BIT for the BR plane. This format only supports images with a width that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    ...
    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 10-bit G component in the top 10 bits of each 16-bit word of plane 0, a 10-bit B component in the top 10 bits of each 16-bit word of plane 1, and a 10-bit R component in the top 10 bits of each 16-bit word of plane 2, with the bottom 6 bits of each word unused. The horizontal and vertical dimensions of the R and B planes are halved relative to the image dimensions, and each R and B component is shared with the G components for which ⌊i G ×0.5⌋=i B =i R and ⌊j G ×0.5⌋=j B =j R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, VK_IMAGE_ASPECT_PLANE_1_BIT for the B plane, and VK_IMAGE_ASPECT_PLANE_2_BIT for the R plane. This format only supports images with a width and height that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16 = 1000156012,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 10-bit G component in the top 10 bits of each 16-bit word of plane 0, and a two-component, 32-bit BR plane 1 consisting of a 10-bit B component in the top 10 bits of the word in bytes 0..1, and a 10-bit R component in the top 10 bits of the word in bytes 2..3, with the bottom 6 bits of each word unused. The horizontal and vertical dimensions of the BR plane are halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R and ⌊j G ×0.5⌋=j B =j R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, and VK_IMAGE_ASPECT_PLANE_1_BIT for the BR plane. This format only supports images with a width and height that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16 = 1000156013,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 10-bit G component in the top 10 bits of each 16-bit word of plane 0, a 10-bit B component in the top 10 bits of each 16-bit word of plane 1, and a 10-bit R component in the top 10 bits of each 16-bit word of plane 2, with the bottom 6 bits of each word unused. The horizontal dimension of the R and B plane is halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, VK_IMAGE_ASPECT_PLANE_1_BIT for the B plane, and VK_IMAGE_ASPECT_PLANE_2_BIT for the R plane. This format only supports images with a width that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16 = 1000156014,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 10-bit G component in the top 10 bits of each 16-bit word of plane 0, and a two-component, 32-bit BR plane 1 consisting of a 10-bit B component in the top 10 bits of the word in bytes 0..1, and a 10-bit R component in the top 10 bits of the word in bytes 2..3, with the bottom 6 bits of each word unused. The horizontal dimension of the BR plane is halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, and VK_IMAGE_ASPECT_PLANE_1_BIT for the BR plane. This format only supports images with a width that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    ...
    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 16-bit G component in each 16-bit word of plane 0, a 16-bit B component in each 16-bit word of plane 1, and a 16-bit R component in each 16-bit word of plane 2. The horizontal and vertical dimensions of the R and B planes are halved relative to the image dimensions, and each R and B component is shared with the G components for which ⌊i G ×0.5⌋=i B =i R and ⌊j G ×0.5⌋=j B =j R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, VK_IMAGE_ASPECT_PLANE_1_BIT for the B plane, and VK_IMAGE_ASPECT_PLANE_2_BIT for the R plane. This format only supports images with a width and height that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G16_B16_R16_3PLANE_420_UNORM = 1000156029,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 16-bit G component in each 16-bit word of plane 0, and a two-component, 32-bit BR plane 1 consisting of a 16-bit B component in the word in bytes 0..1, and a 16-bit R component in the word in bytes 2..3. The horizontal and vertical dimensions of the BR plane are halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R and ⌊j G ×0.5⌋=j B =j R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, and VK_IMAGE_ASPECT_PLANE_1_BIT for the BR plane. This format only supports images with a width and height that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G16_B16R16_2PLANE_420_UNORM = 1000156030,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 16-bit G component in each 16-bit word of plane 0, a 16-bit B component in each 16-bit word of plane 1, and a 16-bit R component in each 16-bit word of plane 2. The horizontal dimension of the R and B plane is halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R. The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, VK_IMAGE_ASPECT_PLANE_1_BIT for the B plane, and VK_IMAGE_ASPECT_PLANE_2_BIT for the R plane. This format only supports images with a width that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    VK_FORMAT_G16_B16_R16_3PLANE_422_UNORM = 1000156031,

    /// <summary>
    /// Specifies an unsigned normalized multi-planar format that has a 16-bit G component in each 16-bit word of plane 0, and a two-component, 32-bit BR plane 1 consisting of a 16-bit B component in the word in bytes 0..1, and a 16-bit R component in the word in bytes 2..3. The horizontal dimension of the BR plane is halved relative to the image dimensions, and each R and B value is shared with the G components for which ⌊i G ×0.5⌋=i B =i R . The location of each plane when this image is in linear layout can be determined via vkGetImageSubresourceLayout, using VK_IMAGE_ASPECT_PLANE_0_BIT for the G plane, and VK_IMAGE_ASPECT_PLANE_1_BIT for the BR plane. This format only supports images with a width that is a multiple of two.
    /// </summary>
    /// <remarks>Provided by VK_VERSION_1_1</remarks>
    ...
    /// <summary>
    /// Specifies a two-component, fixed-point format where most significant bit specifies the sign bit, next 10 bits specify the integer value and last 5 bits represent the fractional value.
    /// </summary>
    /// <remarks>Provided by VK_NV_optical_flow</remarks>
    VK_FORMAT_R16G16_S10_5_NV = 1000464000,

    /// <summary>
    /// Specifies a four-component, 16-bit packed unsigned normalized format that has a 1-bit A component in bit 15, a 5-bit B component in bits 10..14, a 5-bit G component in bits 5..9, and a 5-bit R component in bits 0..4.
    /// </summary>
    /// <remarks>Provided by VK_KHR_maintenance5</remarks>
    VK_FORMAT_A1B5G5R5_UNORM_PACK16_KHR = 1000470000,

    /// <summary>
    /// Specifies a one-component, 8-bit unsigned normalized format that has a single 8-bit A component.
    /// </summary>
    /// <remarks>Provided by VK_KHR_maintenance5</remarks>
    VK_FORMAT_A8_UNORM_KHR = 1000470001,

    /// <inheritdoc cref="VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK" />
    /// <remarks>Provided by VK_EXT_texture_compression_astc_hdr</remarks>
    VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT = VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK,

    /// <inheritdoc cref="VK_FORMAT_G8B8G8R8_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G8B8G8R8_422_UNORM_KHR = VK_FORMAT_G8B8G8R8_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_B8G8R8G8_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_B8G8R8G8_422_UNORM_KHR = VK_FORMAT_B8G8R8G8_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G8_B8_R8_3PLANE_420_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G8_B8_R8_3PLANE_420_UNORM_KHR = VK_FORMAT_G8_B8_R8_3PLANE_420_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G8_B8R8_2PLANE_420_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G8_B8R8_2PLANE_420_UNORM_KHR = VK_FORMAT_G8_B8R8_2PLANE_420_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G8_B8_R8_3PLANE_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G8_B8_R8_3PLANE_422_UNORM_KHR = VK_FORMAT_G8_B8_R8_3PLANE_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G8_B8R8_2PLANE_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G8_B8R8_2PLANE_422_UNORM_KHR = VK_FORMAT_G8_B8R8_2PLANE_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G8_B8_R8_3PLANE_444_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G8_B8_R8_3PLANE_444_UNORM_KHR = VK_FORMAT_G8_B8_R8_3PLANE_444_UNORM,

    /// <inheritdoc cref="VK_FORMAT_R10X6_UNORM_PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_R10X6_UNORM_PACK16_KHR = VK_FORMAT_R10X6_UNORM_PACK16,

    /// <inheritdoc cref="VK_FORMAT_R10X6G10X6_UNORM_2PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_R10X6G10X6_UNORM_2PACK16_KHR = VK_FORMAT_R10X6G10X6_UNORM_2PACK16,

    /// <inheritdoc cref="VK_FORMAT_R10X6G10X6B10X6A10X6_UNORM_4PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_R10X6G10X6B10X6A10X6_UNORM_4PACK16_KHR = VK_FORMAT_R10X6G10X6B10X6A10X6_UNORM_4PACK16,

    /// <inheritdoc cref="VK_FORMAT_G10X6B10X6G10X6R10X6_422_UNORM_4PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G10X6B10X6G10X6R10X6_422_UNORM_4PACK16_KHR = VK_FORMAT_G10X6B10X6G10X6R10X6_422_UNORM_4PACK16,

    /// <inheritdoc cref="VK_FORMAT_B10X6G10X6R10X6G10X6_422_UNORM_4PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_B10X6G10X6R10X6G10X6_422_UNORM_4PACK16_KHR = VK_FORMAT_B10X6G10X6R10X6G10X6_422_UNORM_4PACK16,

    /// <inheritdoc cref="VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16_KHR = VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16_KHR = VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16_KHR = VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16_KHR = VK_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16_KHR = VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_R12X4_UNORM_PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_R12X4_UNORM_PACK16_KHR = VK_FORMAT_R12X4_UNORM_PACK16,

    /// <inheritdoc cref="VK_FORMAT_R12X4G12X4_UNORM_2PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_R12X4G12X4_UNORM_2PACK16_KHR = VK_FORMAT_R12X4G12X4_UNORM_2PACK16,

    /// <inheritdoc cref="VK_FORMAT_R12X4G12X4B12X4A12X4_UNORM_4PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_R12X4G12X4B12X4A12X4_UNORM_4PACK16_KHR = VK_FORMAT_R12X4G12X4B12X4A12X4_UNORM_4PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4B12X4G12X4R12X4_422_UNORM_4PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G12X4B12X4G12X4R12X4_422_UNORM_4PACK16_KHR = VK_FORMAT_G12X4B12X4G12X4R12X4_422_UNORM_4PACK16,

    /// <inheritdoc cref="VK_FORMAT_B12X4G12X4R12X4G12X4_422_UNORM_4PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_B12X4G12X4R12X4G12X4_422_UNORM_4PACK16_KHR = VK_FORMAT_B12X4G12X4R12X4G12X4_422_UNORM_4PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16_KHR = VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16_KHR = VK_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16_KHR = VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16_KHR = VK_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16_KHR = VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G16B16G16R16_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G16B16G16R16_422_UNORM_KHR = VK_FORMAT_G16B16G16R16_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_B16G16R16G16_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_B16G16R16G16_422_UNORM_KHR = VK_FORMAT_B16G16R16G16_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G16_B16_R16_3PLANE_420_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G16_B16_R16_3PLANE_420_UNORM_KHR = VK_FORMAT_G16_B16_R16_3PLANE_420_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G16_B16R16_2PLANE_420_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G16_B16R16_2PLANE_420_UNORM_KHR = VK_FORMAT_G16_B16R16_2PLANE_420_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G16_B16_R16_3PLANE_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G16_B16_R16_3PLANE_422_UNORM_KHR = VK_FORMAT_G16_B16_R16_3PLANE_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G16_B16R16_2PLANE_422_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G16_B16R16_2PLANE_422_UNORM_KHR = VK_FORMAT_G16_B16R16_2PLANE_422_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G16_B16_R16_3PLANE_444_UNORM" />
    /// <remarks>Provided by VK_KHR_sampler_ycbcr_conversion</remarks>
    VK_FORMAT_G16_B16_R16_3PLANE_444_UNORM_KHR = VK_FORMAT_G16_B16_R16_3PLANE_444_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G8_B8R8_2PLANE_444_UNORM" />
    /// <remarks>Provided by VK_EXT_ycbcr_2plane_444_formats</remarks>
    VK_FORMAT_G8_B8R8_2PLANE_444_UNORM_EXT = VK_FORMAT_G8_B8R8_2PLANE_444_UNORM,

    /// <inheritdoc cref="VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16" />
    /// <remarks>Provided by VK_EXT_ycbcr_2plane_444_formats</remarks>
    VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT = VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16" />
    /// <remarks>Provided by VK_EXT_ycbcr_2plane_444_formats</remarks>
    VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT = VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16,

    /// <inheritdoc cref="VK_FORMAT_G16_B16R16_2PLANE_444_UNORM" />
    /// <remarks>Provided by VK_EXT_ycbcr_2plane_444_formats</remarks>
    VK_FORMAT_G16_B16R16_2PLANE_444_UNORM_EXT = VK_FORMAT_G16_B16R16_2PLANE_444_UNORM,

    /// <inheritdoc cref="VK_FORMAT_A4R4G4B4_UNORM_PACK16" />
    /// <remarks>Provided by VK_EXT_4444_formats</remarks>
    VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT = VK_FORMAT_A4R4G4B4_UNORM_PACK16,

    /// <inheritdoc cref="VK_FORMAT_A4B4G4R4_UNORM_PACK16" />
    /// <remarks>Provided by VK_EXT_4444_formats</remarks>
