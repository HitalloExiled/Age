...
{
    public struct ComposedTreeTraversalEnumeratorV2 : IEnumerator<Node>, IEnumerable<Node>
    {
        #region 8-bytes
        ...
        public ComposedTreeTraversalEnumeratorV2(Node root)
        {
            this.root = root;
        ...
        public readonly ComposedTreeTraversalEnumeratorV2 GetEnumerator() => this;
