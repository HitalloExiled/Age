...
public readonly partial record struct CommandRange
{
    ...
    public readonly int Length => this.Post.Length > 0 ? this.Post.End - this.Pre.Start : this.Pre.Length;
    ...
    public static implicit operator Range (in CommandRange commandRange) => new(commandRange.Pre.Start, commandRange.Post.End);
}
