...
public record OldStyle
{
    ...
    private OldStyle(StyleData data) =>
        this.data = data;

    public OldStyle() { }

    public static OldStyle Merge(OldStyle left, OldStyle right) =>
    ...
    internal void Copy(OldStyle source) =>
        this.data = source.data;

    internal void Copy(OldStyle source, StyleProperty property) =>
        this.data.Copy(source.data, property);

    internal void Merge(OldStyle source) =>
