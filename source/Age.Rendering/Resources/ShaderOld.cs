...
public abstract class ShaderOld(RenderPass renderPass) : Resource
{
...
public abstract unsafe class ShaderOld<TVertexInput, TPushConstant> : ShaderOld
...
where TPushConstant : IPushConstant
{
    ...
    public ShaderOld(RenderPass renderPass, Span<string> files, in ShaderOptions options) : base(renderPass)
    {
