...
public class CanvasWireframeShader(RenderPass renderPass, uint subpass, bool watch) : CanvasShader(renderPass, subpass, $"Canvas/{nameof(CanvasWireframeShader)}.frag", StencilKind.Content, watch)
{
