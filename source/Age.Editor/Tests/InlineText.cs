...
{
    public static uint BorderSize { get; set; } = 10;
    ...
    public static void Setup(Canvas canvas)
    {
        ...
        var horizontal_a_child1 = new Span { Name = "X",     Text = "X",        Style = new() { Border = new(BorderSize, 0,     Color.Red),      FontSize = 48, FontFamily = "Helvetica Neue", Color = Color.Red, Margin = new(null, (Pixel)10) } };
        ...
        var vertical_a_child4 = new Span { Text = "Hello",         Style = new() { Border = new(BorderSize, 0, Color.Margenta), Color = Color.White, Alignment = AlignmentType.Top,    Margin = new((Pixel)4) } };
        var vertical_a_child5 = new Span { Text = "World!!!",      Style = new() { Border = new(BorderSize, 0, Color.Margenta), Color = Color.White, Alignment = AlignmentType.Bottom, Margin = new((Pixel)4) } };
        ...
        var vertical_c_child1 = new Span { Name = "Vertical", Text = "Vertical", Style = new() { Border = new(BorderSize, 0, Color.Red), Margin = new(null, (Pixel)10), FontSize = 48, FontFamily = "Helvetica Neue", Color = Color.Red } };
        ...
        var vertical_c_child5 = new Span { Text = "Hello",         Style = new() { Border = new(BorderSize, 0, Color.Margenta), Color = Color.White, Alignment = AlignmentType.Left,    Margin = new((Pixel)4) } };
        var vertical_c_child6 = new Span { Text = "World!!!",      Style = new() { Border = new(BorderSize, 0, Color.Margenta), Color = Color.White, Alignment = AlignmentType.Right, Margin = new((Pixel)4) } };
