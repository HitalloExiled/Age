...
/// <content>
/// Contains the <see cref="MESSAGE_BOX_OPTIONS"/> nested type.
/// </content>
internal static partial class User32
{
    ...
    public enum MESSAGE_BOX_OPTIONS : uint
    {
        ...
        /// <summary>
        /// Adds a Help button to the message box. When the user clicks the Help button or presses F1, the system sends a <see cref="WINDOW_MESSAGE.WM_HELP"/> message to the owner.
        /// </summary>
        MB_HELP = 0x004000,
